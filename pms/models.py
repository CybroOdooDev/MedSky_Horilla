...
class Meetings(HorillaModel):
    ...
    employee_id = models.ManyToManyField(
        Employee, related_name="meeting_employee", verbose_name=_("Employee"),
    )
    ...
    answer_employees = models.ManyToManyField(
        ...
        help_text=_("Select the employees who can respond to question template in this meeting's, if any are added.")
    )
