...
from base.methods import filtersubordinatesemployeemodel, get_working_days, is_reportingmanager, reload_queryset
...
class BulkAttendanceRequestForm(ModelForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        if request.user.has_perm('attendance.add_attendance') or is_reportingmanager(request):
            ...
            self.fields['employee_id'].queryset = Employee.objects.filter(employee_user_id=request.user)
