    ...
    for attendance_data in attendance_dicts:
        ...
        try:
            ...
            if work_type is None:
                attendance_data["Work Type Error"] = f"Invalid work type '{work_type_id}'"
                save = False
            ...
            if attendance_date is not None:
                if attendance_date >= today:
                    attendance_data["Attendance Date Validation Error"] = "Attendance date in future"
                    save = False

            if check_in_date is not None:
                if check_in_date >= today:
                    attendance_data["Check-in Validation Error"] = "Attendance check in date in future"
                    save = False

            if check_out_date is not None:
                if check_out_date >= today:
                    attendance_data["Check-out Validation Error"] = "Attendance check out date in future"
                    save = False
