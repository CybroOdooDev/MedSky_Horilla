...
from base.methods import filtersubordinates, get_key_instances, get_pagination, is_reportingmanager, sortby
...
def ticket_view(request):
    ...
    my_tickets = tickets.filter(employee_id = employee
    )|tickets.filter(created_by = request.user)
    all_tickets=[]
